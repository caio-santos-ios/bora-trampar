...
namespace api_bora_trampar.src.Controllers
{
    ...
    public class DocumentController(IDocumentService service) : ControllerBase
    {
        ...
        {
            ResponseApi<Document?> response = await service.GetByIdAsync(id);
            return StatusCode(response.StatusCode, new { response.Result });
        }
        ...
        public async Task<IActionResult> Create([FromBody] CreateDocumentRequest request)
        {
            ...
            ResponseApi<Document?> response = await service.CreateAsync(request);
            return StatusCode(response.StatusCode, new { response.Result });
        }
        ...
        public async Task<IActionResult> Update([FromBody] UpdateDocumentRequest request)
        {
            ...
            ResponseApi<Document?> response = await service.UpdateAsync(request);
            return StatusCode(response.StatusCode, new { response.Result });
        }
        ...
        public async Task<IActionResult> Delete(string id)
        {
            ...
            ResponseApi<Document?> response = await service.DeleteAsync(new() { Id = id, DeletedBy = userId });
