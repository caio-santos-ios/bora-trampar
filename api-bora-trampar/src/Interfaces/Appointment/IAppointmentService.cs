...
namespace api_bora_trampar.src.Interfaces
{
    public interface IAppointmentService
    {
        ...
        Task<ResponseApi<Appointment?>> StartAsync(string id, string userId);
        Task<ResponseApi<Appointment?>> FinishAsync(string id, string userId);
        Task<ResponseApi<Appointment?>> CancelByCustomerAsync(string id, string userId);
